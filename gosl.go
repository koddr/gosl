// Package gosl (or Go Snippet Library) provides snippets collection for working
// with routine operations in your Go programs with a super user-friendly API
// and the most efficient performance.
package gosl

type Utility struct{}
type GenericUtility[T any, K comparable] struct{}

func (u *Utility) ToBytes(str string) ([]byte, error) {
	return ToBytes(str)
}

func (u *Utility) ToString(byteSlice []byte) (string, error) {
	return ToString(byteSlice)
}
